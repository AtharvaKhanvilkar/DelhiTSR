...
# PER BANK ALIASES 
LENDER_ALIASES = {
    # --- Public & Private Sector Commercial Banks ---
    ...
    "axis_bank": ["Axis Bank", "Axis Bank Ltd", "UTI Bank"],
    ...
    "karur_vysya_bank": ["Karur Vysya Bank", "KVB"],
    "city_union_bank": ["City Union Bank", "CUB"],
    "tamilnad_mercantile_bank": ["Tamilnad Mercantile Bank", "TMB"],
    "j_and_k_bank": ["J&K Bank", "Jammu and Kashmir Bank"],
    "dbs_bank_india": ["DBS Bank", "DBS Bank India"],
    "standard_chartered_bank": ["Standard Chartered", "Standard Chartered Bank"],
    "hsbc_bank": ["HSBC", "HSBC Bank India"],
    "citibank_india": ["Citibank", "Citi Bank"],

    # --- Historical Merged Banks ---
    "vijaya_bank": ["Vijaya Bank"],
    "dena_bank": ["Dena Bank"],
    "corporation_bank": ["Corporation Bank"],
    "andhra_bank": ["Andhra Bank"],
    "syndicate_bank": ["Syndicate Bank"],
    "oriental_bank_of_commerce": ["OBC", "Oriental Bank of Commerce"],
    "united_bank_of_india": ["United Bank of India"],
    "allahabad_bank": ["Allahabad Bank"],

    # --- Housing Finance Companies (HFCs) ---
    "lic_housing_finance": ["LICHFL", "LIC Housing Finance", "LIC HFL", "LIC Housing Finance Ltd"],
    "hdfc_ltd": ["HDFC Ltd", "Housing Development Finance Corporation", "HDFC Limited"],
    "pnb_housing_finance": ["PNB Housing", "PNB Housing Finance", "PNB Housing Finance Ltd"],
    "can_fin_homes": ["Can Fin Homes", "Can Fin Homes Ltd"],
    "indiabulls_housing_finance": ["Indiabulls Housing Finance", "IBHFL", "Sammaan Capital"],
    "aavas_financiers": ["Aavas Financiers", "Aavas Financiers Ltd", "Au Housing Finance"],
    "aadhar_housing_finance": ["Aadhar Housing Finance", "Aadhar Housing", "DHFL Vysya"],
    "repco_home_finance": ["Repco Home Finance", "Repco Home Finance Ltd"],
    "gic_housing_finance": ["GIC Housing Finance", "GIC Housing"],
    "home_first_finance": ["Home First Finance", "HomeFirst", "Home First Finance Company"],
    "tata_capital_housing_finance": ["Tata Capital Housing Finance", "TCHFL"],
    "bajaj_housing_finance": ["Bajaj Housing Finance", "BHFL"],
    "icici_home_finance": ["ICICI Home Finance", "ICICI HFC"],
    "godrej_housing_finance": ["Godrej Housing Finance", "GHF"],
    "aditya_birla_housing_finance": ["Aditya Birla Housing Finance", "ABHFL"],
    "mahindra_housing_finance": ["Mahindra Rural Housing Finance", "Mahindra Housing Finance"],
    "sundaram_home_finance": ["Sundaram Home Finance", "Sundaram BNP Paribas Home Finance"],
    "reliance_home_finance": ["Reliance Home Finance", "RHFL"],
    "cholamandalam_housing_finance": ["Cholamandalam Housing Finance", "Chola Home Finance"],
    "shriram_housing_finance": ["Shriram Housing Finance", "SHFL"],
    "muthoot_homefin": ["Muthoot Homefin", "Muthoot Homefin India Ltd"],
    "manappuram_home_finance": ["Manappuram Home Finance", "MAHOFIN"],
    "vastu_housing_finance": ["Vastu Housing Finance", "Vastu Housing"],
    "aptus_value_housing_finance": ["Aptus Value Housing Finance", "Aptus Finance"],
    "capri_global_housing_finance": ["Capri Global Housing Finance", "Capri Global"],
    "motilal_oswal_home_finance": ["Motilal Oswal Home Finance", "Aspire Home Finance"],
    "centrum_housing_finance": ["Centrum Housing Finance", "CHFL"],
    "wonder_home_finance": ["Wonder Home Finance"],
    "star_housing_finance": ["Star Housing Finance"],
    "iifl_home_finance": ["IIFL Home Finance", "IIFL HFL"],
    "svatantra_housing_finance": ["Svatantra Housing Finance"],
    "shubham_housing_development": ["Shubham Housing Development Finance", "Shubham Housing"],
    "srg_housing_finance": ["SRG Housing Finance"],
    "edelweiss_housing_finance": ["Edelweiss Housing Finance", "EHFL"],
    "piramal_capital_housing_finance": ["Piramal Capital & Housing Finance", "Piramal Housing", "DHFL"],
    "smfg_india_home_first": ["SMFG India Home Finance", "Fullerton India Home Finance"],
    "lt_housing_finance": ["L&T Housing Finance", "LT Housing"],
    "hinduja_housing_finance": ["Hinduja Housing Finance", "HHFL"],
    "hero_housing_finance": ["Hero Housing Finance", "HHFL Hero"],
    "religare_housing_development": ["Religare Housing Development Finance", "RHDFCL"],
    "nivara_home_finance": ["Nivara Home Finance"],
    "trucap_finance": ["TruCap Finance", "TruHome Finance"],
    "altum_credo_home_finance": ["Altum Credo Home Finance"],
    "kogta_financial": ["Kogta Financial", "Kogta Housing Finance"],
    "ummeed_housing_finance": ["Ummeed Housing Finance"],
    "easy_home_finance": ["Easy Home Finance"],
    "micro_housing_finance_corp": ["Micro Housing Finance Corporation", "MHFC"],
    "aviom_india_housing": ["Aviom India Housing Finance", "Aviom Housing"],
    "fasttrack_housing_finance": ["Fasttrack Housing Finance"],
    "west_end_housing_finance": ["West End Housing Finance"],
    "varashakti_housing_finance": ["Varashakti Housing Finance"],
    "viva_home_finance": ["Viva Home Finance"],
    "sangam_housing_finance": ["Sangam Home Loans", "Sangam Housing Finance"],
    "mas_rural_housing_mortgage": ["MAS Rural Housing & Mortgage Finance", "MAS Housing"],

    # --- Non-Banking Financial Companies (NBFCs) ---
    "bajaj_finance": ["Bajaj Finance", "Bajaj Finserv"],
    "cholamandalam_investment": ["Cholamandalam Investment and Finance", "CIFCL", "Chola Finance"],
    "shriram_finance": ["Shriram Finance", "Shriram Transport Finance", "Shriram City Union"],
    "tata_capital": ["Tata Capital", "Tata Capital Financial Services", "TCFSL"],
    "mahindra_financial_services": ["Mahindra & Mahindra Financial Services", "MMFSL", "Mahindra Finance"],
    "aditya_birla_finance": ["Aditya Birla Finance", "ABFL"],
    "muthoot_finance": ["Muthoot Finance", "Muthoot Group"],
    "manappuram_finance": ["Manappuram Finance", "Manappuram"],
    "lt_finance": ["L&T Finance", "LTF", "L&T Finance Holdings"],
    "sundaram_finance": ["Sundaram Finance", "Sundaram Finance Ltd"],
    "iifl_finance": ["IIFL Finance", "India Infoline Finance"],
    "piramal_enterprises": ["Piramal Enterprises", "Piramal Finance"],
    "edelweiss_financial": ["Edelweiss Financial Services", "Edelweiss Finance"],
    "hero_fincorp": ["Hero Fincorp", "Hero Fincorp Ltd"],
    "tvs_credit_services": ["TVS Credit Services", "TVS Credit"],
    "incred_financial_services": ["Incred Financial Services", "InCred"],
    "northern_arc_capital": ["Northern Arc Capital", "Northern Arc", "IFMR Capital"],
    "sbfc_finance": ["SBFC Finance", "SBFC Finance Ltd"],
    "krazybee_services": ["KrazyBee Services", "KrazyBee"],
    "creditaccess_grameen": ["CreditAccess Grameen", "CAGrameen"],
    "oxyzo_financial_services": ["Oxyzo Financial Services", "Oxyzo"],
    "vivriti_capital": ["Vivriti Capital"],
    "avanti_finance": ["Avanti Finance"],
    "neogrowth_credit": ["NeoGrowth Credit", "NeoGrowth"],
    "u_gro_capital": ["U Gro Capital", "UGRO Capital"],
    "clix_capital": ["Clix Capital Services", "Clix Capital"],
    "flexiloans_epimoney": ["FlexiLoans", "Epimoney"],
    "aye_finance": ["Aye Finance"],
    "veritas_finance": ["Veritas Finance"],
    "capsave_finance": ["Capsave Finance"],
    "western_capital_advisors": ["Western Capital Advisors", "Western Capital"],
    "fedbank_financial_services": ["Fedbank Financial Services", "Fedfina"],
    "muthoot_microfin": ["Muthoot Microfin"],
    "spandana_spoorthy": ["Spandana Spoorthy Financial", "Spandana Spoorthy"],
    "asirvad_microfinance": ["Asirvad Microfinance", "Asirvad"],
    "annapurna_finance": ["Annapurna Finance"],
    "belstar_microfinance": ["Belstar Microfinance"],
    "sonata_finance": ["Sonata Finance"],
    "satin_creditcare": ["Satin Creditcare Network", "Satin Creditcare"],
    "fusion_micro_finance": ["Fusion Micro Finance", "Fusion Microfinance"],
    "mas_financial_services": ["MAS Financial Services", "MAS Finance"],
    "dmi_finance": ["DMI Finance"],
    "payu_finance": ["PayU Finance India", "PayU Finance"],
    "navi_finserv": ["Navi Finserv", "Navi Technologies"]
}
...
def _normalize_lender(name):
    ...
    for canonical_key, aliases in LENDER_ALIASES.items():
        for alias in aliases:
            ...
            # Stage 2: Balanced Levenshtein Similarity calculation (>= 85% threshold)
    ...
    # Apply strict balanced threshold (minimum 85% similarity required for fuzzy match)
...
def api_summarize_discrepancy(project_name):
    """
    Executes real Gemini 2.5 Flash AI inference to generate a concise, monochrome 2-sentence
    discrepancy analysis for the advocate finding modal.
    """
    if not check_project_owner(project_name):
    ...
    # Import Gemini AI synthesizer helper from main.py
    from main import summarize_discrepancy_with_ai
    
    summary_text = summarize_discrepancy_with_ai(payload)
    
    if not summary_text:
        # High-density fallback if Gemini key is temporarily offline
        ...
        summary_text = f"Title record variance detected on Doc {doc_no} ({event_date}). Expected record state [{exp_str or 'Valid Entry'}] differs from actual recorded state [{act_str or 'Unverified State'}], requiring verification against SRO books."
